...
public class Contact {
  ...
  private static final String CONTACT_OBJECT = "NOTNULL";
  private static final String CONTACT_OBJECT_NUM = "0123456789";
  ...
  Contact() {
    this.contactId = CONTACT_OBJECT;
    this.firstName = CONTACT_OBJECT;
    this.lastName = CONTACT_OBJECT;
    this.phoneNumber = CONTACT_OBJECT_NUM;
    this.address = CONTACT_OBJECT;
  }
